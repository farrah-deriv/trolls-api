    ...
    return (
        <>
            <div className={isAppRegistration ? styles["form-content"] : styles["playground-box"]}>
                {isAppRegistration ? (
                    <Title className={styles["app-registration-subheader"]} headerSize="h3">
                        {title}
                    </Title>
                ) : (
                ...
                <textarea
                    ...
                    className={
                        isAppRegistration
                            ? `${styles["textarea-request"]} ${styles["registration-request"]}`
                ...
                <div className={styles["json-btn-wrapper"]}>
                    <div
                        className={
                            isAppRegistration
                                ? `${styles["btn-reset"]} ${styles["gray-btn-submit"]}`
                                : `${styles["btn-reset"]} ${styles["btn-reset-playground"]}`
                        }
                    >
                        {buttonReset}
                    </div>
                    <div className={styles["btn-submit"]}>{buttonSend}</div>
                </div>
